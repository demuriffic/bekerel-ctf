...
import { CheckCircle2, Flame, ExternalLink, Filter, Lock } from 'lucide-react';
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between gap-2 flex-wrap">
                    ...
                    <div className="flex items-center gap-2">
                      {isAdmin && ch.prerequisiteTitle && (
                        <span className="text-[10px] px-2 py-0.5 rounded bg-cyan-950/50 border border-cyan-500/30 text-cyan-300 font-mono-code flex items-center gap-1">
                          <Lock className="w-2.5 h-2.5" />
                          <span>Req: {ch.prerequisiteTitle}</span>
                        </span>
                      )}
